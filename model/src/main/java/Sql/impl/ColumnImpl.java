 ...
 * </p>
 * <ul>
 *   <li>{@link Sql.impl.ColumnImpl#getTableCat <em>Table Cat</em>}</li>
 *   <li>{@link Sql.impl.ColumnImpl#getTableSchem <em>Table Schem</em>}</li>
 *   <li>{@link Sql.impl.ColumnImpl#getTableName <em>Table Name</em>}</li>
 *   <li>{@link Sql.impl.ColumnImpl#getColumnName <em>Column Name</em>}</li>
 *   <li>{@link Sql.impl.ColumnImpl#getDataType <em>Data Type</em>}</li>
 *   <li>{@link Sql.impl.ColumnImpl#getTypeName <em>Type Name</em>}</li>
 *   <li>{@link Sql.impl.ColumnImpl#getColumnSize <em>Column Size</em>}</li>
 *   <li>{@link Sql.impl.ColumnImpl#getBufferLength <em>Buffer Length</em>}</li>
 *   <li>{@link Sql.impl.ColumnImpl#getDecimalDigits <em>Decimal Digits</em>}</li>
 *   <li>{@link Sql.impl.ColumnImpl#getNumPrecRadix <em>Num Prec Radix</em>}</li>
 *   <li>{@link Sql.impl.ColumnImpl#getNullable <em>Nullable</em>}</li>
 *   <li>{@link Sql.impl.ColumnImpl#getRemarks <em>Remarks</em>}</li>
 *   <li>{@link Sql.impl.ColumnImpl#getColumnDef <em>Column Def</em>}</li>
 *   <li>{@link Sql.impl.ColumnImpl#getSqlDataType <em>Sql Data Type</em>}</li>
 *   <li>{@link Sql.impl.ColumnImpl#getSqlDatetimeSub <em>Sql Datetime Sub</em>}</li>
 *   <li>{@link Sql.impl.ColumnImpl#getCharOctetLength <em>Char Octet Length</em>}</li>
 *   <li>{@link Sql.impl.ColumnImpl#getOrdinalPosition <em>Ordinal Position</em>}</li>
 *   <li>{@link Sql.impl.ColumnImpl#getIsNullable <em>Is Nullable</em>}</li>
 *   <li>{@link Sql.impl.ColumnImpl#getScopeCatalog <em>Scope Catalog</em>}</li>
 *   <li>{@link Sql.impl.ColumnImpl#getScopeSchema <em>Scope Schema</em>}</li>
 *   <li>{@link Sql.impl.ColumnImpl#getScopeTable <em>Scope Table</em>}</li>
 *   <li>{@link Sql.impl.ColumnImpl#getSourceDataType <em>Source Data Type</em>}</li>
 *   <li>{@link Sql.impl.ColumnImpl#getIsAutoincrement <em>Is Autoincrement</em>}</li>
 *   <li>{@link Sql.impl.ColumnImpl#getIsGeneratedcolumn <em>Is Generatedcolumn</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ColumnImpl extends MinimalEObjectImpl.Container implements Column {
	...
	public String getTableCat() {
		return (String)eDynamicGet(SqlPackage.COLUMN__TABLE_CAT, SqlPackage.Literals.COLUMN__TABLE_CAT, true, true);
	}
	...
	public void setTableCat(String newTableCat) {
		eDynamicSet(SqlPackage.COLUMN__TABLE_CAT, SqlPackage.Literals.COLUMN__TABLE_CAT, newTableCat);
	}
	...
	public String getTableSchem() {
		return (String)eDynamicGet(SqlPackage.COLUMN__TABLE_SCHEM, SqlPackage.Literals.COLUMN__TABLE_SCHEM, true, true);
	}
	...
	public void setTableSchem(String newTableSchem) {
		eDynamicSet(SqlPackage.COLUMN__TABLE_SCHEM, SqlPackage.Literals.COLUMN__TABLE_SCHEM, newTableSchem);
	}
	...
	public String getTableName() {
		return (String)eDynamicGet(SqlPackage.COLUMN__TABLE_NAME, SqlPackage.Literals.COLUMN__TABLE_NAME, true, true);
	}
	...
	public void setTableName(String newTableName) {
		eDynamicSet(SqlPackage.COLUMN__TABLE_NAME, SqlPackage.Literals.COLUMN__TABLE_NAME, newTableName);
	}
	...
	public String getColumnName() {
		return (String)eDynamicGet(SqlPackage.COLUMN__COLUMN_NAME, SqlPackage.Literals.COLUMN__COLUMN_NAME, true, true);
	}
	...
	public void setColumnName(String newColumnName) {
		eDynamicSet(SqlPackage.COLUMN__COLUMN_NAME, SqlPackage.Literals.COLUMN__COLUMN_NAME, newColumnName);
	}
	...
	public Integer getDataType() {
		return (Integer)eDynamicGet(SqlPackage.COLUMN__DATA_TYPE, SqlPackage.Literals.COLUMN__DATA_TYPE, true, true);
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SqlPackage.COLUMN__TABLE_CAT:
				return getTableCat();
			case SqlPackage.COLUMN__TABLE_SCHEM:
				return getTableSchem();
			case SqlPackage.COLUMN__TABLE_NAME:
				return getTableName();
			case SqlPackage.COLUMN__COLUMN_NAME:
